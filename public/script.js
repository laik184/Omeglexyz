...
function adjustVideoLayout() {
    ...
    // Ensure floating video is hidden on desktop to prevent duplicates
    if (floatingVideo && !isMobileDevice()) {
        floatingVideo.style.display = 'none';
    } else if (floatingVideo && isMobileDevice()) {
    ...
    try {
        ...
        if (localVideo && localStream) {
            ...
            try {
                ...
                // Handle floating video only on mobile devices to prevent duplicates on desktop
                const floatingVideo = document.querySelector('.local-video-float video');
                if (floatingVideo && isMobileDevice()) {
